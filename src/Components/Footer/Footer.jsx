...
const Footer = () => {
  return (
    ...
    <div className="w-full max-w-6xl mx-auto px-5">
      ...
      <span className="text-3xl font-semibold">SetAzaiza</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="content">
          ...
          <div className="flex space-x-4 mt-4">
            <Link
              to="https://www.facebook.com/profile.php?id=61563674222628"
              target="_blank"
            ...
            <Link
              to="https://www.instagram.com/set_aziza?igsh=MTN1NG9kdmpraHN1eA=="
              target="_blank"
              className="p-3 bg-white text-mainColor rounded-full hover:bg-gray-300 transition duration-300"
            >
      ...
      <Link to="https://food2go.online/" target="_blank" className="flex items-center justify-center gap-2 text-sm mt-2 border-t border-white pt-4">
        ...
        <h1 className="text-white font-semibold text-lg">SetAzaiza</h1>
        </Link>
    </div>
  </div>
  );
