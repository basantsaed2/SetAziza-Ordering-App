            ...
            <div className={`w-full md:w-1/2 h-full flex flex-col items-center`}>
                <img src={logo} width={180} height={180} alt="Main Logo" />
                 <div className="flex items-center justify-center gap-2">
                    <h1 className="text-mainColor font-semibold text-2xl">SetAzaiza</h1>
                </div>
            </div>

            <div className={`w-full md:w-1/2 h-full flex flex-col gap-3 p-2 md:p-4 items-center justify-center`}>
                <div className="flex gap-5">
                    <Link to="/setaziza_menu" className="bg-[#9E090F1A] flex flex-col gap-3  items-center justify-center rounded-xl p-2 md:p-6">
                        <MenuIcon/>
                ...
                <div className="flex gap-1 p-4 pb-0">
                    ...
                    <Link target="_blank" to="#" className="opacity-50 cursor-not-allowed">
                        <AppleIcon/>
                    </Link>      
                </div>
            </div>
